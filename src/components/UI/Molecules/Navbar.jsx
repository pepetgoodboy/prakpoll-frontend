...
import LinkScrollDesk from "../Atoms/Link/LinkScrollDesk";
import LinkScrollMobile from "../Atoms/Link/LinkScrollMobile";
          ...
          <div className="pt-5 pb-6 px-5">
            ...
            <div className="mt-6">
              <nav className="grid gap-y-6">
                ...
                <LinkScrollMobile
                  to="about"
                  logo={<FaQuestion className="h-6 w-6 text-[#5046E4]" />}
                  text="Tentang Kami"
                />
                <LinkNavMobile
                  to="/elections"
